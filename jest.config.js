...
module.exports = {
  ...
  transformIgnorePatterns: [
    `/node_modules/(?!\\.pnpm|@neo4j-devtools/word-color|lodash-es|@neo4j/browser-lambda-parser|react-dnd|@react-dnd|dnd-core|monaco-editor|antlr4|@neo4j-cypher/(.+)|internmap|${reactMarkdownESModuleDeps}|d3-[^-]+|uuid)`
  ],
  moduleNameMapper: {
