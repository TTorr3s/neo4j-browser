...
export const NavigationButtonContainer = styled.li<{ isOpen: boolean }>`
  ...
  --sidebar-icon-color: ${props =>
    props.isOpen
      ? props.theme.sidebarIconActive
      : props.theme.sidebarIconInactive};
  &:focus {
    outline: none;
  }
  &:hover {
    --sidebar-icon-color: ${props => props.theme.sidebarIconActive};
  }
`
...
const StyledDrawerFormButton = styled(StyledSecondaryFormButton)`
  ...
  border-color: ${props => props.theme.drawerTextMuted};
  outline: none;
  &:hover {
